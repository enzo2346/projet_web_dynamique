...
if ($db_found) {
    ...
    $sql1="DELETE FROM `rendezvous` WHERE rendezvous.date='$date' AND rendezvous.creneau='$creneau' AND rendezvous.idpersonnel='$idpersonnel';";
    $result = mysqli_query($db_handle, $sql);
    $result1 = mysqli_query($db_handle, $sql1);
    header('location: rendezvouspersonnel.php');
}
